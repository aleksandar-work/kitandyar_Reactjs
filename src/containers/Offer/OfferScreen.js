...
export default class OfferScreen extends PureComponent {
 
  state = {
    layout: 3,
    ListProducts: ProductsOffer,
  ...
  _renderItem(item) {
    ...
    if (layout === 4)
      return (<ProductListItem product={item} layout={layout} />)
    else
    ...
    return (
      <View style={[AppStyles.mainContainer]}>
        ...
        />
        {
          ...
          >
            <Text style={styles.title}>KStore Deals</Text>
            <Text style={styles.description}>12 Products</Text>
          </Animated.View>
        }
      </View >
    );
