          ...
          <View style={{ flex: 4 }}>
            ...
            </Text>
            {
              ...
              <Text style={styles.date}>
                {i18n.t('payment_item_component.exp_date', { locale: lang } )} {item.expDate}
              </Text>
            }
          </View>
          <View style={{
            ...
            <Icon
              ...
              onPress={() => { this.props.navigation.navigate("UpdateCardCredit") }}
            />
          </View>
        </TouchableOpacity>
      </BackgroundGradient>
...
export default withNavigation(PaymentItem);
